<template>
  <div class="development">
      ...
      <div class="tariff__container">
        <div>
          <div class="tariff-item tariff-item_1">
            <input class="tariff-item__input" id="tariff-1" type="radio" name="tariff" value="Дёшево" v-model="pickedTariff">
        ...
        <div>
          <div class="tariff-item tariff-item_2">
            <input class="tariff-item__input" id="tariff-2" type="radio" name="tariff" value="Стандарт" v-model="pickedTariff">
        ...
        <div>
          <div class="tariff-item tariff-item_3">
            <input class="tariff-item__input" id="tariff-3" type="radio" name="tariff" value="Богато" v-model="pickedTariff">
    ...
    <div class="budget" v-if="step == 1">
      <div class="section-desc">Сколько на кармане?</div>
